		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comui5testconnectivityforextranalservice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comui5testconnectivityforextranalservice-display": {
								"semanticObject": "comui5testconnectivityforextranalservice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ui5.testconnectivityforextranalservice",
									"url": sap.ui.require.toUrl("com/ui5/testconnectivityforextranalservice")
								}
							}
						}
					}
